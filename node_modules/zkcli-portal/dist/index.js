...
export default class SetupModule extends Module {
    constructor(config) {
        ...
        this.composeFile = path.join(files.getDirPath(import.meta.url), "../docker-compose.yml");
        this.inMemoryNode = {
            id: 260,
