...
export const setupConfig = async (options = {}) => {
    ...
    if (chain) {
        ...
        selectedNode = modules.find((module) => module.package.name === options.node);
    ...
    const modulesWithSupportInfo = await Promise.all(potentialModules.map(async (module) => {
        try {
            return {
                instance: module,
