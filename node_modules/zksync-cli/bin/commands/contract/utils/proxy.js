...
const EIP1967_PROXY_IMPLEMENTATION_SLOT = BigNumber.from(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("eip1967.proxy.implementation")))
    .sub(1)
    .toHexString();
const EIP1967_PROXY_BEACON_SLOT = BigNumber.from(ethers.utils.keccak256(ethers.utils.toUtf8Bytes("eip1967.proxy.beacon")))
    .sub(1)
    .toHexString();
const EIP1822_PROXY_IMPLEMENTATION_SLOT = ethers.utils.keccak256(ethers.utils.toUtf8Bytes("PROXIABLE"));
const getAddressSafe = async (getAddressFn) => {
    try {
...
export const getProxyImplementation = async (proxyContractAddress, provider) => {
