...
const logFoundryInfo = () => {
    ...
    const tipMessage = "- Tip: You can use the " + chalk.blueBright("--rpc-url") + " option to specify the network to deploy to.";
...
const logHardhatInfo = (packageManager) => {
    const contractsDir = "/contracts";
    const deploymentScriptsDir = "/deploy";
    const tipMessage = "- Tip: You can use the " + chalk.blueBright("--network") + " option to specify the network to deploy to.";
    ...
    const { privateKey } = await inquirer.prompt([
        {
            ...
            validate: (input) => {
                if (!input)
                    return true; // since it's optional
